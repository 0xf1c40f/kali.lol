...
if not isfolder("kali.lol") then
    makefolder("kali.lol")
end
if not isfolder("kali.lol/Config") then
    makefolder("kali.lol/Config")
end
...
local ConfigFile = "kali.lol/Config/Chloe_" .. gameName .. ".json"
...
function GuiFunc:ToggleUI()
    ...
    local oldGui = parent:FindFirstChild("ToggleUIButton")
    if oldGui then
        oldGui:Destroy()
    end
